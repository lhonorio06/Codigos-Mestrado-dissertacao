...
path_lst = '/content/drive/MyDrive/MESTRADO/01. DADOS/00.DADOS_ARCGIS_MAPAS/INVERNO_2000_2013/INVERNO_MEDIANA_2000_2013.tif'
path_mag = '/content/drive/MyDrive/MESTRADO/01. DADOS/00.DADOS_ARCGIS_MAPAS/INVERNO_2000_2013/INVERNO_TEN_SEN_SLOPE_2000_2013.tif'
path_sig = '/content/drive/MyDrive/MESTRADO/01. DADOS/02.ANO A ANO MEDIANAS/SEM EXCLUSÃO/INVERNO/Mapa_Significancia_ Inverno_2000_2013.tif'
path_vet = '/content/drive/MyDrive/MESTRADO/01. DADOS/RESULTADOS_ESTATISTICOS/PONTOS/pontos.shp'
folder_output = '/content/drive/MyDrive/MESTRADO/01. DADOS/RESULTADOS_ESTATISTICOS/INVERNO_2000_2013/'
...
# Check for the correct filename in the directory
!ls -F "/content/drive/MyDrive/MESTRADO/01. DADOS/02.ANO A ANO MEDIANAS/SEM EXCLUSÃO/INVERNO/"
...
df_plot = df_final.dropna(subset=['lst_inverno'])
...
gdf_sig_extraida.to_file(f'{folder_output}pixels_ZONAL_inverno_COMPLETO_0013.shp')
df_final.to_csv(f'{folder_output}TABELA_FINAL_ZONAL_INVERNO_COMPLETA_0013.csv', index=False, sep=';', encoding='utf-8-sig')
