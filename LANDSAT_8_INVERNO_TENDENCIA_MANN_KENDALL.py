...
if not tif_files:
    print(f"Erro: Nenhum arquivo .tif encontrado no caminho: {base_path} com o padrão 'mediana_inverno_L8_*.tif'")
else:
    ...
    if src is None:
        ...
        plt.title("Tendência de Temperatura de Superfície no Inverno (2014–2023)")
        ...
        output_path = os.path.join(base_path, 'Tendencia_Kendall_inverno_L8_novo.tif')
