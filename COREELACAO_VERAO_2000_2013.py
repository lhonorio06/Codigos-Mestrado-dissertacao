...
path_lst = '/content/drive/MyDrive/MESTRADO/01. DADOS/00.DADOS_ARCGIS_MAPAS/VERAO_2000_2013/VERAO_MEDIANA_2000_2013.tif'
path_mag = '/content/drive/MyDrive/MESTRADO/01. DADOS/00.DADOS_ARCGIS_MAPAS/VERAO_2000_2013/VERAO_TEN_SEN_SLOPE_2000_2013.tif'
path_sig = '/content/drive/MyDrive/MESTRADO/01. DADOS/02.ANO A ANO MEDIANAS/SEM EXCLUSÃO/VERÃO/Mapa_Significancia_Verao_2000_2013.tif'
path_vet = '/content/drive/MyDrive/MESTRADO/01. DADOS/RESULTADOS_ESTATISTICOS/PONTOS/pontos.shp'
folder_output = '/content/drive/MyDrive/MESTRADO/01. DADOS/RESULTADOS_ESTATISTICOS/VERAO_2000_2013/'
...
gdf_sig_extraida.to_file(f'{folder_output}pixels_ZONAL_verao_COMPLETO_0013.shp')
df_final.to_csv(f'{folder_output}TABELA_FINAL_ZONAL_VERAO_COMPLETA_0013.csv', index=False, sep=';', encoding='utf-8-sig')
